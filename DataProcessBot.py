...
if not os.path.exists('./fig/'):
    os.mkdir('./fig/')
#检查当前目录下是否存在名为fig的子目录。如果不存在，os.mkdir('./fig/')将创建这个目录。这个目录可能用于存储随后生成的图形或图像文件。
toolModels = [
    roadVolumeTrend('./fig/'),
    roadVolume(),
    roadNameToID(),
...
# 4. You are forbidden to fabricate any tool names. If you can no````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````````   `````````````````````````````````````````                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   qq                                                                  q                                                                                                                                               q                           `   2qqt find any appropriate tool for your task, try to do it using your own ability and knowledge as a chat AI.
